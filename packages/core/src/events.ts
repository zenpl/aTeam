...
export const KEY_SYMBOLS = [
  ...
  "UNTIL_UNDER_A_MINUTE", "VERIFY_ASK", "WATCH_LINES", "ago", "alertContact", "allocationSummary",
  "alsoHere", "applyReading", "batches", "batchesEmptyLine", "blockedWhy", "board",
  "capabilityKey", "checkShape", "coverage", "defaultMissed", "deployHistory", "dueDefaults",
  "exampleLine", "followUps", "gateHonesty", "honestyLine", "humanImpactPromised", "inFlightGroups",
  "injectDirty", "injectManySites", "injectNoFile", "injectNoSite", "injectNotGit", "judgeSeam",
  "lightSeamLine", "manual", "manualFor", "missingCard", "nobodyElse", "overdueByPresence",
  "owedSentences", "releaseUnits", "responsibilityAppendix", "runtimeAllocation", "saidHops", "sayReading",
  "shapeFor", "slimBoard", "span", "splitRelease", "standInBlocker", "standIns",
  "staticAllocation", "taskHeading", "until", "validate", "validateTask", "valueForm",
