...
export const KEY_SYMBOLS = [
  ...
  "UNTIL_UNDER_A_MINUTE", "VERIFY_ASK", "ago", "alertContact", "allocationSummary", "alsoHere",
  "applyReading", "batches", "batchesEmptyLine", "blockedWhy", "board", "capabilityKey",
  "checkShape", "coverage", "defaultMissed", "deployHistory", "dueDefaults", "exampleLine",
  "followUps", "gateHonesty", "honestyLine", "humanImpactPromised", "inFlightGroups", "injectDirty",
  "injectManySites", "injectNoFile", "injectNoSite", "injectNotGit", "judgeSeam", "lightSeamLine",
  ...
  "taskHeading", "until", "validate", "validateTask", "valueForm", "verifierEligibility",
  "whoCanVerify", "whoElseTouches",
] as const;
