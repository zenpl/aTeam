...
export const KEY_SYMBOLS = [
  ...
  "SHOWS_GATE_BLIND", "SHOWS_RULE", "SPAN_UNDER_A_MINUTE", "STAND_IN_ASK_TITLE", "UNTIL_UNDER_A_MINUTE", "VERIFY_ASK",
  "ago", "alertContact", "allocationSummary", "alsoHere", "applyReading", "batches",
  "batchesEmptyLine", "blockedWhy", "board", "capabilityKey", "checkShape", "coverage",
  "deployHistory", "dueDefaults", "exampleLine", "followUps", "gateHonesty", "honestyLine",
  "humanImpactPromised", "inFlightGroups", "injectDirty", "injectManySites", "injectNoFile", "injectNoSite",
  "injectNotGit", "judgeSeam", "lightSeamLine", "manual", "manualFor", "missingCard",
  ...
  "standInBlocker", "standIns", "staticAllocation", "taskHeading", "until", "validate",
  "validateTask", "valueForm", "verifierEligibility", "whoCanVerify", "whoElseTouches",
] as const;
